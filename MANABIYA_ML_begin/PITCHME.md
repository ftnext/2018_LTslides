...
- モデルは未知のデータについて予測する |
- (例)レコメンド: <br>商品の評価データをもとに作ったモデルで<br>ユーザへのオススメ商品を予測 |
...
- 数学的な勉強をするというアプローチも<br>もちろんあり |

+++

### 一番重要と思うこと: <br>データの傾向の把握
...
- APIとして公開されているAIを使うことで、<br>機械学習に取り組む必要がない場合がある
- scikit-learnやAzure ML Studioなどから<br>自分にあったツールを使おう
